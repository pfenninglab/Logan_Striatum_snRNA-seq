...
## relabel the unk_all group by the refined labels
obj_merged$celltype1 = ifelse(obj_merged$celltype1 != 'MSNs', obj_merged$celltype3,
                              obj_merged$celltype1)
...
table(obj_merged$celltype1, obj_merged$celltype3)
