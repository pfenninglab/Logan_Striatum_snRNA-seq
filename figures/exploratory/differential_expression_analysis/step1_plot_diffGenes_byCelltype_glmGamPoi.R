...
#############################################################################
# 3) use glmGamPoi to detect per-cell type differential state analyses 
## for ea. cell type, run glmGamPoi w/ default parameters
## https://github.com/csoneson/conquer_comparison/blob/master/scripts/apply_glmGamPoi.R
save_res_fn = here(DATADIR,'rdas', 'BU_Run1_Striatum_glmGamPoiRes_byCelltype2_N4.rds')
...
plot_fn = here(PLOTDIR, 'BU_Run1_Striatum_glmGamPoiRes_N4.byCelltype2.topDiffGene.pdf')
