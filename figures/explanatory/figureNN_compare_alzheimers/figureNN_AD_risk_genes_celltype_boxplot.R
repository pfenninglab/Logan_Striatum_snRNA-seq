...
to_plot= c('MTRNR2L8', 'APOE')
plot_fn = here(PLOTDIR,'plots', 'figureNN_compare_alzheimers_risk_gene_boxplot.pdf')
pdf(plot_fn, height = 35/in2mm, width = 60/in2mm, onefile = T)
